  ...
  useEffect(() => {
    ...
    api
      ...
      .then((res) => {
        setContent(
          res.data.content ||
            "You’re doing great — keep building your streak today."
        );
      ...
      .catch(() => {
        setContent(
          "Good morning ☀️ Stay consistent and complete your habits today."
        );
      })
      .finally(() =>
        setLoading(false)
  ...
  return (
    <div className="relative rounded-2xl p-5 glass overflow-hidden animate-slide-up">
      ...
      <div className="flex items-start gap-3 pr-6 relative">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-400 to-amber-500 text-white flex items-center justify-center shrink-0 shadow-lg shadow-amber-500/30 animate-float">
          <Sun size={20} />
        </div>
